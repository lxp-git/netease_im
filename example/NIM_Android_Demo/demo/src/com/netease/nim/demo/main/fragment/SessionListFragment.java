...
public class SessionListFragment extends MainTabFragment {
    ...
    private boolean isOpenFlutter = true;
        ...
        fragment.setCallback(new RecentContactsCallback() {
            ...
            public void onItemClick(RecentContact recent) {
                ...
                switch (recent.getSessionType()) {
                    case P2P:
                        if (isOpenFlutter) {
                            String dartUrl = "session?type=p2p&sessionId=" + recent.getContactId();
//                      FlutterEngine flutterEngine = FlutterEngineCache.getInstance().get(NimApplication.FLUTTER_ENGINE_ID);
//
//                        // Configure an initial route.
//                        flutterEngine.getNavigationChannel().setInitialRoute(dartUrl);
//                        // Start executing Dart code to pre-warm the FlutterEngine.
//                        flutterEngine.getDartExecutor().executeDartEntrypoint(
//                          DartExecutor.DartEntrypoint.createDefault()
//                        );
//                        // Cache the FlutterEngine to be used by FlutterActivity or FlutterFragment.
//                      FlutterEngineCache.getInstance().put(NimApplication.FLUTTER_ENGINE_ID, flutterEngine);
//                      Intent flutterIntent = FlutterActivity
//                        .withCachedEngine(NimApplication.FLUTTER_ENGINE_ID)
////                                .destroyEngineWithActivity(true)
//                        .build(getActivity());
                            Intent flutterIntent = FlutterActivity
                              .withNewEngine()
                              .initialRoute(dartUrl)
                              .build(getActivity());
